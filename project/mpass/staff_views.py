...
def persons(request):
    ...
    context = {"persons": persons, "count_person_in_groups": count_person_in_groups, 'title': 'Staff'}
...
def new_person(request, id_=None):
    ...
    if id_:
        ...
        form = forms.PersonForm(request.POST or None, request.FILES or None, instance=obj)
